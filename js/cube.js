(function() {
  ...
  function CubeCSS(options) {
    ...
    this.u2i  = function() { enqueue(turnU,  -2) };
    this.r2i  = function() { enqueue(turnR,  -2) };
    this.f2i  = function() { enqueue(turnF,  -2) };
    this.d2i  = function() { enqueue(turnD,  -2) };
    this.l2i  = function() { enqueue(turnL,  -2) };
    this.b2i  = function() { enqueue(turnB,  -2) };
    ...
    this.uw2i = function() { enqueue(turnUw, -2) };
    this.rw2i = function() { enqueue(turnRw, -2) };
    this.fw2i = function() { enqueue(turnFw, -2) };
    this.dw2i = function() { enqueue(turnDw, -2) };
    this.lw2i = function() { enqueue(turnLw, -2) };
    this.bw2i = function() { enqueue(turnBw, -2) };
    ...
    this.x2i  = function() { enqueue(turnX,  -2) };
    this.y2i  = function() { enqueue(turnY,  -2) };
    this.z2i  = function() { enqueue(turnZ,  -2) };
    ...
    this.m2i  = function() { enqueue(turnM,  -2) };
    this.e2i  = function() { enqueue(turnE,  -2) };
    this.s2i  = function() { enqueue(turnS,  -2) };
