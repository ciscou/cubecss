(function() {
  ...
  function CubeCSS(options) {
    ...
    */
    ...
    var E1SLICE = [
      L1, L2, F1, F2, R1, R2, B3, B4,
      LF1, LB1, RF1, RB1
    ];

    var E2SLICE = [
      L3, L4, F3, F4, R3, R4, B1, B2,
      LF2, LB2, RF2, RB2
    ];

    var S1SLICE = [
      U1, U2, R1, R3, D3, D4, L1, L3,
      UL1, UR1, DL1, DR1
    ];

    var S2SLICE = [
      U3, U4, R2, R4, D1, D2, L2, L4,
      UL2, UR2, DL2, DR2
    ];
    ...
    function turn2UCallback(qts) {
      ...
      for(var i=0; i<cycles; i++) {
        ...
        LF1.stickers.left.style.backgroundColor = RF1.stickers.front.style.backgroundColor;
        RF1.stickers.front.style.backgroundColor = RB1.stickers.right.style.backgroundColor;
        RB1.stickers.right.style.backgroundColor = LB1.stickers.back.style.backgroundColor;
        LB1.stickers.back.style.backgroundColor = tmp;

        tmp = LF1.stickers.front.style.backgroundColor;
        LF1.stickers.front.style.backgroundColor = RF1.stickers.right.style.backgroundColor;
        RF1.stickers.right.style.backgroundColor = RB1.stickers.back.style.backgroundColor;
        RB1.stickers.back.style.backgroundColor = LB1.stickers.left.style.backgroundColor;
    ...
    function turn2DCallback(qts) {
      ...
      for(var i=0; i<cycles; i++) {
        ...
        LF2.stickers.left.style.backgroundColor = RF2.stickers.front.style.backgroundColor;
        RF2.stickers.front.style.backgroundColor = RB2.stickers.right.style.backgroundColor;
        RB2.stickers.right.style.backgroundColor = LB2.stickers.back.style.backgroundColor;
        LB2.stickers.back.style.backgroundColor = tmp;

        tmp = LF2.stickers.front.style.backgroundColor;
        LF2.stickers.front.style.backgroundColor = RF2.stickers.right.style.backgroundColor;
        RF2.stickers.right.style.backgroundColor = RB2.stickers.back.style.backgroundColor;
        RB2.stickers.back.style.backgroundColor = LB2.stickers.left.style.backgroundColor;
    ...
    function turn3Uw(qts) {
      ...
      if(animating) {
        ...
        E2SLICE.forEach(function(cubieContainer) {
          remaining++;
          rotateElY(cubieContainer.el, -qts, cb);
        });
      } else {
    ...
    function turnDCallback(qts) {
      ...
      for(var i=0; i<cycles; i++) {
        tmp = D1.stickers.down.style.backgroundColor;
        D1.stickers.down.style.backgroundColor = D2.stickers.down.style.backgroundColor;
        D2.stickers.down.style.backgroundColor = D4.stickers.down.style.backgroundColor;
        D4.stickers.down.style.backgroundColor = D3.stickers.down.style.backgroundColor;
        D3.stickers.down.style.backgroundColor = tmp;
        ...
        tmp = DL1.stickers.down.style.backgroundColor;
        DL1.stickers.down.style.backgroundColor = DF1.stickers.down.style.backgroundColor;
        DF1.stickers.down.style.backgroundColor = DR2.stickers.down.style.backgroundColor;
        DR2.stickers.down.style.backgroundColor = DB2.stickers.down.style.backgroundColor;
        DB2.stickers.down.style.backgroundColor = tmp;

        tmp = DL1.stickers.left.style.backgroundColor;
        DL1.stickers.left.style.backgroundColor  = DF1.stickers.front.style.backgroundColor;
        DF1.stickers.front.style.backgroundColor = DR2.stickers.right.style.backgroundColor;
        DR2.stickers.right.style.backgroundColor = DB2.stickers.back.style.backgroundColor;
        DB2.stickers.back.style.backgroundColor  = tmp;

        tmp = DL2.stickers.down.style.backgroundColor;
        DL2.stickers.down.style.backgroundColor = DF2.stickers.down.style.backgroundColor;
        DF2.stickers.down.style.backgroundColor = DR1.stickers.down.style.backgroundColor;
        DR1.stickers.down.style.backgroundColor = DB1.stickers.down.style.backgroundColor;
        DB1.stickers.down.style.backgroundColor = tmp;

        tmp = DL2.stickers.left.style.backgroundColor;
        DL2.stickers.left.style.backgroundColor  = DF2.stickers.front.style.backgroundColor;
        DF2.stickers.front.style.backgroundColor = DR1.stickers.right.style.backgroundColor;
        DR1.stickers.right.style.backgroundColor = DB1.stickers.back.style.backgroundColor;
        DB1.stickers.back.style.backgroundColor  = tmp;
      }
    }
    ...
    function turnLCallback(qts) {
      ...
      for(var i=0; i<cycles; i++) {
        tmp = L1.stickers.left.style.backgroundColor;
        L1.stickers.left.style.backgroundColor = L2.stickers.left.style.backgroundColor;
        L2.stickers.left.style.backgroundColor = L4.stickers.left.style.backgroundColor;
    ...
    function turn2F(qts) {
      ...
      if(animating) {
        S2SLICE.forEach(function(cubieContainer) {
          remaining++;
          rotateElZ(cubieContainer.el, qts, cb);
        });
      } else {
